...
-------------------------------------------------------------------------------
		...
		},
		{
			...
			icon = "__kosmuxa-extend__/graphics/icons/medium-passive-provider-container.png",
			icon_size = 64,
			icon_mipmaps = 4,
			localised_name = {"entity-name.whs-medium-passive-provider-chest"},
			localised_description = {"entity-description.whs-medium-passive-provider-chest"},
			subgroup = "storage",
			order = "a",
			stack_size = 25,
			place_result = "whs-medium-passive-provider-chest"
		},
		{
			type = "item",
			...
			icon_size = 64,
			icon_mipmaps = 4,
			localised_name = {"entity-name.whs-medium-storage-chest"},
			localised_description = {"entity-description.whs-medium-storage-chest"},
			subgroup = "storage",
			order = "a",
			stack_size = 25,
...
-------------------------------------------------------------------------------
		...
		},
		{
			...
			icon = "__kosmuxa-extend__/graphics/icons/big-active-provider-container.png",
			icon_size = 64,
			icon_mipmaps = 4,
			localised_name = {"entity-name.whs-big-active-provider-chest"},
			localised_description = {"entity-description.whs-big-active-provider-chest"},
			subgroup = "storage",
			order = "a",
			stack_size = 25,
			place_result = "whs-big-active-provider-chest"
		},
		{
			type = "item",
			name = "whs-big-buffer-chest",
			icon = "__kosmuxa-extend__/graphics/icons/big-buffer-container.png",
			icon_size = 64,
			icon_mipmaps = 4,
			localised_name = {"entity-name.whs-big-buffer-chest"},
			localised_description = {"entity-description.whs-big-buffer-chest"},
			subgroup = "storage",
			order = "a",
			stack_size = 25,
			place_result = "whs-big-buffer-chest"
		},
		{
			type = "item",
			name = "whs-big-requester-chest",
			icon = "__kosmuxa-extend__/graphics/icons/big-requester-container.png",
			icon_size = 64,
			icon_mipmaps = 4,
			localised_name = {"entity-name.whs-big-requester-chest"},
			localised_description = {"entity-description.whs-big-requester-chest"},
			subgroup = "storage",
			order = "a",
			stack_size = 25,
			place_result = "whs-big-requester-chest"
		},		
		{
			type = "item",
			name = "whs-big-chest",
